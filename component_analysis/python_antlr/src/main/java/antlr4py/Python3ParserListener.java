...
public interface Python3ParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link Python3Parser#dotted_name_decoretor}.
	 * @param ctx the parse tree
	 */
	void enterDotted_name_decoretor(Python3Parser.Dotted_name_decoretorContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#dotted_name_decoretor}.
	 * @param ctx the parse tree
	 */
	void exitDotted_name_decoretor(Python3Parser.Dotted_name_decoretorContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link Python3Parser#string_stmt}.
	 * @param ctx the parse tree
	 */
	void enterString_stmt(Python3Parser.String_stmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#string_stmt}.
	 * @param ctx the parse tree
	 */
	void exitString_stmt(Python3Parser.String_stmtContext ctx);
	/**
